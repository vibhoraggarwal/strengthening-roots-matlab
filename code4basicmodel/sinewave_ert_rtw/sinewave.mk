...
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/sinewave
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /home/vibhor/git/StrengtheningRoots_MATLAB/code4basicmodel
ARCH                      = glnxa64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/sinewave
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/sinewave_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
%.o : $(START_DIR)/sinewave_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/sinewave_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
